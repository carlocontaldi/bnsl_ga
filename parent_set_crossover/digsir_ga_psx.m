function [dag,sc_star,conv,last_gen] = digsir_ga_psx(ss,data,N,M,MP,alpha,d,scoring_fn,bnet)
% Diversity-Guided Site-specific Rate GA implementing Parent Set Crossover
%% Init
